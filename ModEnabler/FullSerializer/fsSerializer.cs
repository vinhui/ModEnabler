...
namespace FullSerializer
{
    public class fsSerializer
    {
        ...
        /// </summary>
        internal static bool IsReservedKeyword(string key)
        {
        ...
        internal static void StripDeserializationMetadata(ref fsData data)
        {
        ...
        internal class fsLazyCycleDefinitionWriter
        {
            ...
            internal void WriteDefinition(int id, fsData data)
            {
            ...
            internal void WriteReference(int id, Dictionary<string, fsData> dict)
            {
        ...
        internal void AddProcessor(fsObjectProcessor processor)
        {
        ...
        /// deserialized.
        /// </summary>
        internal void AddConverter(fsBaseConverter converter)
        {
