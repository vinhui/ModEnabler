...
{
    internal static class fsVersionManager
    {
        private static readonly Dictionary<Type, fsOption<fsVersionedType>> _cache = new Dictionary<Type, fsOption<fsVersionedType>>();

        internal static fsResult GetVersionImportPath(string currentVersion, fsVersionedType targetVersion, out List<fsVersionedType> path)
        {
        ...
        internal static fsOption<fsVersionedType> GetVersionedType(Type type)
        {
