...
namespace FullSerializer
{
    ...
    {
        internal static Internal.DirectConverters.AnimationCurve_DirectConverter Register_AnimationCurve_DirectConverter;
    }
}

namespace FullSerializer.Internal.DirectConverters
{
    internal class AnimationCurve_DirectConverter : fsDirectConverter<AnimationCurve>
    {
