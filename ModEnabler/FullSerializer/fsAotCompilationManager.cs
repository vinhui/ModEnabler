...
namespace FullSerializer
{
    ...
    /// </summary>
    internal class fsAotCompilationManager
    {
        /// <summary>
        ...
        /// </summary>
        internal static Dictionary<Type, string> AvailableAotCompilations
        {
            get
            {
        ...
        {
            internal Type Type;
            internal fsMetaProperty[] Members;
            internal bool IsConstructorPublic;
        }
        ...
        internal static bool TryToPerformAotCompilation(Type type, out string aotCompiledClassInCSharp)
        {
        ...
        internal static void AddAotCompilation(Type type, fsMetaProperty[] members, bool isConstructorPublic)
        {
        ...
        private static string GenerateDirectConverterForTypeInCSharp(Type type, fsMetaProperty[] members, bool isConstructorPublic)
        {
            ...
            sb.AppendLine("        internal static Speedup." + typeNameSafeDecl + "_DirectConverter " + "Register_" + typeNameSafeDecl + ";");
            sb.AppendLine("    }");
            sb.AppendLine("}");
            sb.AppendLine();
            sb.AppendLine("namespace FullSerializer.Speedup {");
            sb.AppendLine("    internal class " + typeNameSafeDecl + "_DirectConverter : fsDirectConverter<" + typeName + "> {");
            ...
            sb.AppendLine("        }");
            sb.AppendLine();
            sb.AppendLine("        internal override object CreateInstance(fsData data, Type storageType) {");
