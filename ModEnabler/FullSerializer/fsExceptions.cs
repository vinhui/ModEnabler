...
{
    internal sealed class fsMissingVersionConstructorException : Exception
    {
        internal fsMissingVersionConstructorException(Type versionedType, Type constructorType) :
            base(versionedType + " is missing a constructor for previous model type " + constructorType)
        { }
    }

    internal sealed class fsDuplicateVersionNameException : Exception
    {
        internal fsDuplicateVersionNameException(Type typeA, Type typeB, string version) :
